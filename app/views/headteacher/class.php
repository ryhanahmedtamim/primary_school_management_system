                    ...
                    <table class=" table-bordered">
                        ...
                        ?> 
                        	<tr>
                        		...
                        		<td>
                        			<a class="button-radious-8 button-send  button-hover-blue" href="http://localhost/primary_school_management_system/public/head/studentDetails/<?php echo $data[$k]['s_id']; ?>">Status</a>
                        		</td>
