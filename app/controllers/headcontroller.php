<?php
	...
	class Headcontroller extends Controller
	{
		...
		{
			$this->view("headteacher/setmarks",$data);
		}
		...
		public function amark()
		{
			...
			$Teach = $this->model("Teach");
			$result = $Teach->setmarks($s_id,$sub_id,$term_id,$year,$marks);


			if($result == true)
			{
				header("Location: http://localhost/primary_school_management_system/public/head/setmark/true2");
			}
